...
- Program: `examples/v1-loop-unbounded-budgeted.gr`
...
- Program: `examples/v1-recursive-policy-bounded.gr`
...
- Program: `examples/v1-minsky-branching.gr`
- Env: `GRAPHEME_RUNTIME_MAX_STEPS=none`, `GRAPHEME_RUNTIME_MAX_CALL_DEPTH=none`
- Expected: succeeded
