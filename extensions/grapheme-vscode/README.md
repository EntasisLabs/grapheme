...
VS Code language support for Grapheme Lang (`.gr`) powered by `grapheme-lsp` **0.7.1**.
...
Set `grapheme.lsp.releaseTag` to `v0.7.1` (or `latest`) when using auto-download.
...
- `grapheme.lsp.releaseTag` — use `v0.7.1` for this release train
